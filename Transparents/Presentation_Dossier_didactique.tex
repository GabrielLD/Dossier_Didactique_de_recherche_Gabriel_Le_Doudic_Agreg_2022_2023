...
\end{equation}
  ...
  \begin{frame}{I3. Dépôt d'une goutte de tensioactif}
    ...
    %\begin{figure}
      \centering
      \resizebox{!}{.8\textwidth}{\input{./figures/Marangoni_effect_soluto_capillary.tex}}
      %\end{figure}
    \end{minipage}\hfill
...
\begin{frame}{II.1.Dispositif Experimental}
    \begin{figure}
        ...
        \movie{\includegraphics[width=.65\textwidth]{./figures/Trajectoire_bateau_2.pdf}}{./videos/new_bateau_cuve_fleurie_20hz.avi}
    \end{figure}
\end{frame}
